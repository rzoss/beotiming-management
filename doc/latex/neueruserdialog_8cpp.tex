\hypertarget{neueruserdialog_8cpp}{
\section{neueruserdialog.cpp File Reference}
\label{neueruserdialog_8cpp}\index{neueruserdialog.cpp@{neueruserdialog.cpp}}
}
...
Include dependency graph for neueruserdialog.cpp:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=420pt]{neueruserdialog_8cpp__incl}
\end{center}
\end{figure}
...
Definition in file \hyperlink{neueruserdialog_8cpp-source}{neueruserdialog.cpp}.
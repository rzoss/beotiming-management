...
\begin{center}
\leavevmode
\includegraphics[width=55pt]{_database_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=420pt]{_database_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{CompactList}\small\item\em Diese Klasse symbolisiert die Datenbank. Sie erstellt die Verbindung und stellt verschiedene Servicefunktionen bereit. \item\end{CompactList}\end{CompactItemize}
...
Definition in file \hyperlink{_database_8h-source}{Database.h}.
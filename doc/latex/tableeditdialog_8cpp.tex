\hypertarget{tableeditdialog_8cpp}{
\section{tableeditdialog.cpp File Reference}
\label{tableeditdialog_8cpp}\index{tableeditdialog.cpp@{tableeditdialog.cpp}}
}
Dieser Dialog dient dem Editieren der Eintraege. 

{\tt \#include \char`\"{}tableeditdialog.h\char`\"{}}\par
{\tt \#include \char`\"{}delegates/ResultateDelegate.h\char`\"{}}\par
{\tt \#include \char`\"{}delegates/KontaktDelegate.h\char`\"{}}\par
{\tt \#include \char`\"{}User.h\char`\"{}}\par
{\tt \#include $<$QtSql$>$}\par
{\tt \#include $<$QtGui$>$}\par


Include dependency graph for tableeditdialog.cpp:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=420pt]{tableeditdialog_8cpp__incl}
\end{center}
\end{figure}
...
Definition in file \hyperlink{tableeditdialog_8cpp-source}{tableeditdialog.cpp}.
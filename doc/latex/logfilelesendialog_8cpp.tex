\hypertarget{logfilelesendialog_8cpp}{
\section{logfilelesendialog.cpp File Reference}
\label{logfilelesendialog_8cpp}\index{logfilelesendialog.cpp@{logfilelesendialog.cpp}}
}
...
Include dependency graph for logfilelesendialog.cpp:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=420pt]{logfilelesendialog_8cpp__incl}
\end{center}
\end{figure}
...
Definition in file \hyperlink{logfilelesendialog_8cpp-source}{logfilelesendialog.cpp}.
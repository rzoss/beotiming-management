\hypertarget{_kontakt_delegate_8cpp}{
\section{delegates/KontaktDelegate.cpp File Reference}
\label{_kontakt_delegate_8cpp}\index{delegates/KontaktDelegate.cpp@{delegates/KontaktDelegate.cpp}}
}
...
{\tt \#include \char`\"{}KontaktDelegate.h\char`\"{}}\par
{\tt \#include $<$QtSql$>$}\par
{\tt \#include $<$QtGui$>$}\par


Include dependency graph for KontaktDelegate.cpp:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=104pt]{_kontakt_delegate_8cpp__incl}
\end{center}
\end{figure}
...
Definition in file \hyperlink{_kontakt_delegate_8cpp-source}{KontaktDelegate.cpp}.
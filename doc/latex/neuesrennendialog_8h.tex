\hypertarget{neuesrennendialog_8h}{
\section{neuesrennendialog.h File Reference}
\label{neuesrennendialog_8h}\index{neuesrennendialog.h@{neuesrennendialog.h}}
}
Dieser Dialog dient zum erstellen eines neunen Rennens. 

{\tt \#include $<$QtGui/QDialog$>$}\par
{\tt \#include \char`\"{}ui\_\-neuesrennendialog.h\char`\"{}}\par


Include dependency graph for neuesrennendialog.h:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=420pt]{neuesrennendialog_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=420pt]{neuesrennendialog_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
\begin{CompactItemize}
\item 
class \hyperlink{class_neues_rennen_dialog}{NeuesRennenDialog}
\begin{CompactList}\small\item\em Dieser Dialog dient zum erstellen eines neunen Rennens. \item\end{CompactList}\end{CompactItemize}
...
Definition in file \hyperlink{neuesrennendialog_8h-source}{neuesrennendialog.h}.